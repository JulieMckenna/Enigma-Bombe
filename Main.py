...
e1c.grid(row=15, column=0, columnspan=18)
...
clabel.grid(row=10,column=0,columnspan=18)

ctext = Entry(root,width=50,borderwidth=3)
ctext.grid(row=11,column=0,columnspan=18)

nlabel = Label(root,text="Normal Message")
nlabel.grid(row=12,column=0,columnspan=18)

ntext = Entry(root,width=50,borderwidth=3)
ntext.grid(row=13,column=0,columnspan=18)

plabel = Label(root, text="Plugboard Pairs")
plabel.grid(row=14,column=0,columnspan=18)

ptext = Entry(root,width=50, borderwidth=3)
ptext.grid(row=15,column=0,columnspan=18)
